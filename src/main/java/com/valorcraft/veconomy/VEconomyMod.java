 ...
 * единицах (long), все изменения атомарны и записываются в журнал операций в БД
 * (SQLite или MySQL). Никаких предметов-монет, магазинов и клиентских интерфейсов —
 * только сервер, команды и безопасный Java API.
 */

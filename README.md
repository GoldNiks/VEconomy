...
- **Недельная награда**: раз в ISO-неделю (понедельник, 00:00 в таймзоне фонда)
  ...
  никогда не смешиваются; дневная активность сохраняется в базу до закрытия недели,
  поэтому воскресные часы онлайн не теряются при ротации.
...
| `/money activity`                                  | 0     | Время в сети / активное / AFK, активность за текущую неделю |
| `/money weekly`                                    | 0     | Недельная награда: активная игра, дни, примерная награда, начисление за прошлую неделю |
